...
Based on the BLAST results, there are `r length(pr5_putative_s1)` PR-1 genes in soybean, of which `r nrow(pr5_putative_s2)` were confirmed based on protein domains.
